...
ZoomPic.prototype = 
{
	initialize : function (id)
	{
		...
		this.options = [
			...
			{width:308, height:184, top:23, left:0, zIndex:1},
			{width:330, height:229, top:0, left:160, zIndex:2},
			{width:308, height:184, top:23, left:322, zIndex:1},
		];
	...
	setUp : function ()
	{
		...
		for (i = 0; i < this.aSort.length; i++)
		{
			...
			else
			{
				...
				this.css(this.aSort[i], "bottom", 0);
